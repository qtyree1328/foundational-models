...
def snow_tiles_era5():
    """GET /api/snow/tiles/era5?year=2023&month=01&band=snowfall_sum&palette=cool_blues"""
    try:
        year = request.args.get('year', '2023')
...
def snow_animation_era5_seasonal():
    ...
    try:
        ...
        for m in range(1, 13):
            ...
            cached_url = _get_cached(ck)
            if cached_url:
                frames.append({'month': m, 'monthName': month_names[m-1], 'tileUrl': cached_url}); continue
...
def snow_tiles_modis_snowdays():
    ...
    Count of snow days (NDSI>40) for the water year.
    """
    try:
        year = int(request.args.get('year', '2024'))
...
if __name__ == '__main__':
    ...
    print(f'   Snow endpoints: /api/snow/tiles/*, /api/snow/stats/*, /api/snow/animation/*, /api/snow/trends/*, /api/snow/snotel/*')
